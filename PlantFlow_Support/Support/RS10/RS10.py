...
def RS10(s, Dn = 100, BI = 210, A = 250.0, A1 = 250.0, A2 = 150.0,
  F2 = 500.0, B1 = 0.0, P1 = 0.0, TY = -1, ID = "RS10", **kwargs):
  """
  """
  ...
  if (BPn == 1):
    ...
    m2.translate((A - Fa1/2, 0.0, -Fa1))
    m1.uniteWith(m2)
    m2.erase()

    sP2 = (A - A2 - Fa1/2, 0.0, F2 - Dz/2 - P1)
    sP3 = (-A2, 0.0, -Dz/2 - P1)
  ...
  s.setLinearDimension('F2', 
                      (A - A2 + Fa1/2, 0.0, -Dz/2 - P1), 
                      (A - A2 + Fa1/2, 0.0, F2 - Dz/2 - P1))
