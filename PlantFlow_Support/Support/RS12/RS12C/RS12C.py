...
@param(TY=LENGTH, TooltipLong="|TYPE C = -3|")

def RS12C(s, Dn = 50, BI = 110, A = 300.0, P1 = 0.0, 
  TY = -3, BP = 0, ID = "RS12C", **kwargs):
  """
  """
  ...
  if (BPn == 1):
    ...
    m1.rotateZ(90).rotateY(90).translate((-A, 0.0, Dz/2 + P1))
    ...
    m1.rotateZ(-90).rotateY(90).translate((-A, 0.0, -Dz/2 - Fa1/2 - P1))
    sPL = [(0.0, 0.0, -Dz/2 - P1), (-A, 0.0, -Dz/2 - Fa1/2 - P1)]
    pS2 = (-A, 0.0, -Dz/2 - Fa1 - P1)
  ...
  s.setLinearDimension('A', (0.0, Fa1, Dz/2 + P1), (-A, Fa1, Dz/2 + P1))
