...
def UB2(s, Dn = 50, C = 76.0, L = 70.0, S = 65.0, R = 31.7, 
  B = 120.0, TY = -2, ID = "UB2", **kwargs):
  """
  """
  ...
  elif (TY not in [-1, -2, -3]):
    o1 = ERROR_SHAPE(s, R = 50.0)
    print("Please select as |TYPE A = -1|TYPE B = -2|TYPE C = -3|")
    return
